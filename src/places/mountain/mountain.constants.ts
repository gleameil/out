...
export const MOUNTAIN_IMAGES: ImageCatalog = {
  ...
  hand0: {
    path: new URL('../../../assets/images/darkRoom/grasping-fruit.png?as=webp', import.meta.url),
    alt: 'digging hand',
  },
  hand1: {
    path: new URL('../../../assets/images/mountain/up/grasping-fruit.png?as=webp', import.meta.url),
    alt: 'digging hand',
  },
  oldgoldbg0: {
